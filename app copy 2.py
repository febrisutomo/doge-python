...
def logistic_results():
    try:
        ...
        if missing_cols:
            return jsonify({"error": f"Kolom {missing_cols} tidak ditemukan di file"}), 400
