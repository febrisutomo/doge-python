...
def analyze_logistic_regression():
    try:
        ...
        df_doge["Movement_future"] = df_doge["Movement"].shift(-lag) if lag > 0 else df_doge["Movement"]
        ...
        if scale_flag:
            ...
            X_eval = scaler.transform(X)  # scale juga dataset asli untuk evaluasi
        else:
            X_eval = X
        ...
        # ===== Prediksi di dataset asli (supaya tanggal sinkron) =====
        ...
        # ===== Simpan hasil =====
        result_df = df_merge[["date"] + features].copy()
        ...
        result_json = {
            ...
            "class_distribution_after": dict(collections.Counter(y_resampled)),
